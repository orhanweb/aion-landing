...
export const mockTestimonialsTr: MockTestimonial[] = [
  {
    ...
    outcome: 'Çıktı: ISO 42001 yol haritası ve kontrol boşluğu haritası',
    quote:
  ...
  },
  {
    ...
    outcome: 'Çıktı: Güvenli veri mimarisi ve AI operasyon kontrol seti',
    quote:
  ...
  },
  {
    ...
    outcome: 'Çıktı: Önceliklendirilmiş gap analizi ve sertifikasyon planı',
    quote:
  ...
  },
  {
    ...
    outcome: 'Çıktı: İş sürekliliği senaryoları ve dayanıklılık hedefleri',
    quote:
  ...
  },
  {
    ...
    outcome: 'Çıktı: Sorumlu AI ilkeleri ve yönetim kuruluna hazır sunum seti',
    quote:
...
export const mockTestimonialsEn: MockTestimonial[] = [
  {
    ...
    outcome: 'Output: ISO 42001 roadmap and control gap map',
    quote:
  ...
  },
  {
    ...
    outcome: 'Output: Secure data architecture and AI operations control set',
    quote:
  ...
  },
  {
    ...
    outcome: 'Output: Prioritized gap analysis and certification plan',
  ...
  },
  {
    ...
    outcome: 'Output: Business continuity scenarios and resilience targets',
    quote:
  ...
  },
  {
    ...
    outcome: 'Output: Responsible AI principles and board-ready briefing pack',
    quote:
